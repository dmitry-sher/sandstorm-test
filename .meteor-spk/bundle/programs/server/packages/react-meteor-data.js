...
Object.assign(ReactPureComponent.prototype, ReactMeteorData);                                              // 165
                                                                                                           //
function connect(options) {                                                                                // 167
  var expandedOptions = options;                                                                           // 168
                                                                                                           //
  if (typeof options === 'function') {                                                                     // 169
    expandedOptions = {                                                                                    // 170
      getMeteorData: options                                                                               // 171
    };                                                                                                     // 170
  }                                                                                                        // 173
                                                                                                           //
  var _expandedOptions = expandedOptions,                                                                  // 167
      _getMeteorData = _expandedOptions.getMeteorData,                                                     // 167
      _expandedOptions$pure = _expandedOptions.pure,                                                       // 167
      pure = _expandedOptions$pure === undefined ? true : _expandedOptions$pure;                           // 167
  var BaseComponent = pure ? ReactPureComponent : ReactComponent;                                          // 177
  return function (WrappedComponent) {                                                                     // 178
    return function (_BaseComponent) {                                                                     // 178
      (0, _inherits3.default)(ReactMeteorDataComponent, _BaseComponent);                                   // 178
                                                                                                           //
      function ReactMeteorDataComponent() {                                                                // 178
        (0, _classCallCheck3.default)(this, ReactMeteorDataComponent);                                     // 178
        return (0, _possibleConstructorReturn3.default)(this, _BaseComponent.apply(this, arguments));      // 178
      }                                                                                                    // 178
                                                                                                           //
      ReactMeteorDataComponent.prototype.getMeteorData = function () {                                     // 178
        function getMeteorData() {                                                                         // 178
          return _getMeteorData(this.props);                                                               // 181
        }                                                                                                  // 182
                                                                                                           //
        return getMeteorData;                                                                              // 178
      }();                                                                                                 // 178
                                                                                                           //
      ReactMeteorDataComponent.prototype.render = function () {                                            // 178
        function render() {                                                                                // 178
        ...
        return render;                                                                                     // 178
                                                                                                           ...
                                                                                                           //
      return ReactMeteorDataComponent;                                                                     // 178
    }(BaseComponent);                                                                                      // 178
  };                                                                                                       // 178
}                                                                                                          // 188
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
var hasDisplayedWarning = false;                                                                           // 9
                                                                                                           //
function createContainer(options, Component) {                                                             // 11
  if (!hasDisplayedWarning && Meteor.isDevelopment) {                                                      // 12
    ...
    hasDisplayedWarning = true;                                                                            // 17
  }                                                                                                        // 18
                                                                                                           //
  return connect(options)(Component);                                                                      // 20
}                                                                                                          // 21
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
